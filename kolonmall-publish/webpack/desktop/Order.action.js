...
$(document).on('desktop:Order:load', () => {
  ...
  $('#datepickerStart .ui-datepicker-header').append('<a class="ui-datepicker-first ui-corner-all" data-handler="first" data-event="click"><span class="ui-icon ui-icon-circle-triangle-e">First</span></a>');
  $('#datepickerStart .ui-datepicker-header').append('<a class="ui-datepicker-last ui-corner-all" data-handler="last" data-event="click"><span class="ui-icon ui-icon-circle-triangle-e">Last</span></a>');
  ...
  function getOrderList() {
    ...
    if (searchPeriodDays == 90) {
      ...
      startDate = moment($('#datepickerStart').val()).format('YYYYMMDD');
      endDate = moment($('#datepickerEnd').val()).format('YYYYMMDD');
      console.log('aaaa => ' + startDate);
    }
    const params = {
      startDate,
      endDate,
